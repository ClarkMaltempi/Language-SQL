...
select count(*) AS 'FUNC SEXO FEMININO', sexo
from funcionarios
group by sexo;
...
/*
	...
	DCL - DATA CONTROL LANGUAGE - Controle de Usuários
...
/*alterando o tipo através do change*/
...
/*DIFERENÇA ENTRE OS DOIS ALTERANDO O TIPO "CHANGE" E "MODIFY"*/
ALTER TABLE PRODUTO
CHANGE VALOR_UNITARIO VALOR_UNITARIO INT;
...
INSERT INTO ENDERECO VALUES(NULL,'RUA GOMES FREIRE','CENTRO','RIO DE JANEIRO','RJ',9);
...
/*
	O MODELO ACIMA ESTÁ TRAZENDO O RESULTADO EM BASE DA LINHA 2304, MAS, ESTÁ ACRESCENTENDO UMA NOVA CONDIÇÃO "OR" NA LINHA 20305
	TRAZENDO RESULTADOS QUE NÃO QUEREMOS COMO NESSE CASO "HOMENS".
	PARA RESOLVER ESSE PROBLEMA É ISOLADO A SINTAXE COM "()", LINHA 2336 COMO UMA OPERAÇÃO MATEMÁTICA, ISOLANDO A CONDIÇÃO.
*/
...
/*
	IFNULL (coluna)  - Para que ela funcione precisa de um parametro, que dará o start, esse parametro é alocado dentro do parentese
